## Mini MLP Language Model

### Description
Develop, train, and test a small-scale neural (multi-layer perceptron) language model.

### Objectives
- Understand python lists and multi-dimensional arrays
- Utilize matrix calculations for neural network operations
- Train a model on a small text corpus
- Demonstrate language prediction output

### Required Data Structures
- Vector/Matrix (List/List of List): Storing model weights, inputs, and outputs.
